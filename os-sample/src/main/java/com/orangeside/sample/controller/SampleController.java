 ...
 * 说明：
 */
@Controller @RequestMapping("/sample") public class SampleController {
    private static Logger logger = LoggerFactory.getLogger(SampleController.class);

    @RequestMapping("") public String page() throws Exception {
        return "modules/os-sample/page";
    }

    @RequestMapping("/normalError") public String normalError() throws Exception {
        throw new Exception("normalError");
    }

    @RequestMapping("/ajaxError") public @ResponseBody Object ajaxError() throws Exception {
        throw new Exception("ajaxError");
    }

    @RequestMapping("/normalBusinessError") public String normalBusinessError() throws Exception {
