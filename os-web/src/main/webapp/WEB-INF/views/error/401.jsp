...
<head>
    <meta charset="utf-8"/>
    <title>Metronic | ERROR - 401</title>
    ...
    <link href="<%=basePath%>/assets/admin/pages/css/error.css" rel="stylesheet" type="text/css"/>
    ...
    <link href="<%=basePath%>/assets/admin/layout4/css/layout.css" rel="stylesheet" type="text/css"/>
    <link id="style_color" href="<%=basePath%>/assets/admin/layout4/css/themes/light.css" rel="stylesheet" type="text/css"/>
