...
<head>
  ...
  <link href="<%=basePath%>/assets/global/plugins/morris/morris.css" rel="stylesheet" type="text/css">
  ...
  <link href="<%=basePath%>/assets/admin/layout6/css/layout.css" rel="stylesheet" type="text/css"/>
  <link href="<%=basePath%>/assets/admin/layout6/css/custom.css" rel="stylesheet" type="text/css"/>
  <!-- END THEME STYLES -->
    ...
    <div class="container">
      <div class="havbar-header">
        ...
        <a id="index" class="navbar-brand" href="start.html">
          <img src="<%=basePath%>/assets/admin/layout6/img/logo.png" alt="Logo">
        </a>
        <!-- END LOGO -->
        ...
        <div class="topbar-actions">
          ...
          <div class="btn-group-img btn-group">
            <button type="button" class="btn btn-sm dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
              <img src="<%=basePath%>/assets/admin/layout6/img/avatar1.jpg" alt="">
            </button>
            <ul class="dropdown-menu-v2" role="menu">
              ...
              <li>
                <a href="<%=basePath%>/security/logout">Logout Out</a>
              </li>
            </ul>
          </div>
          <!-- END USER PROFILE -->
            ...
            <div class="portlet-body">
              ...
              <div class="table-scrollable table-scrollable-borderless">
                <table class="table table-hover table-light">
                  ...
                  <tr>
                    <td class="fit">
                      <img class="user-pic" src="<%=basePath%>/assets/admin/layout/img/avatar4.jpg" alt="">
                    </td>
                    <td>
                  ...
                  <tr>
                    <td class="fit">
                      <img class="user-pic" src="<%=basePath%>/assets/admin/layout/img/avatar5.jpg" alt="">
                    </td>
                    <td>
                  ...
                  <tr>
                    <td class="fit">
                      <img class="user-pic" src="<%=basePath%>/assets/admin/layout/img/avatar6.jpg" alt="">
                    </td>
                    <td>
                  ...
                  <tr>
                    <td class="fit">
                      <img class="user-pic" src="<%=basePath%>/assets/admin/layout/img/avatar7.jpg" alt="">
                    </td>
                    <td>
              ...
              <div class="scroller" style="height: 305px;" data-always-visible="1" data-rail-visible1="0" data-handle-color="#D7DCE2">
                <div class="general-item-list">
                  <div class="item">
                    <div class="item-head">
                      <div class="item-details">
                        <img class="item-pic" src="<%=basePath%>/assets/admin/layout/img/avatar4.jpg" alt="">
                  ...
                  <div class="item">
                    <div class="item-head">
                      <div class="item-details">
                        <img class="item-pic" src="<%=basePath%>/assets/admin/layout/img/avatar3.jpg" alt="">
                  ...
                  <div class="item">
                    <div class="item-head">
                      <div class="item-details">
                        <img class="item-pic" src="<%=basePath%>/assets/admin/layout/img/avatar6.jpg" alt="">
                        <a href="" class="item-name primary-link">Nick Larson</a>
                  ...
                  <div class="item">
                    <div class="item-head">
                      <div class="item-details">
                        <img class="item-pic" src="<%=basePath%>/assets/admin/layout/img/avatar7.jpg" alt="">
                        <a href="" class="item-name primary-link">Nick Larson</a>
                  ...
                  <div class="item">
                    <div class="item-head">
                      <div class="item-details">
                        <img class="item-pic" src="<%=basePath%>/assets/admin/layout/img/avatar9.jpg" alt="">
                  ...
                  <div class="item">
                    <div class="item-head">
                      <div class="item-details">
                        <img class="item-pic" src="<%=basePath%>/assets/admin/layout/img/avatar8.jpg" alt="">
                  ...
                  <div class="item">
                    <div class="item-head">
                      <div class="item-details">
                        <img class="item-pic" src="<%=basePath%>/assets/admin/layout/img/avatar2.jpg" alt="">
              ...
              <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                ...
                <ul class="media-list list-items">
                  <li class="media">
                    ...
                    <img class="media-object" src="<%=basePath%>/assets/admin/layout/img/avatar3.jpg" alt="...">
                  ...
                  <li class="media">
                    <img class="media-object" src="<%=basePath%>/assets/admin/layout/img/avatar1.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    ...
                    <img class="media-object" src="<%=basePath%>/assets/admin/layout/img/avatar4.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    <img class="media-object" src="<%=basePath%>/assets/admin/layout/img/avatar2.jpg" alt="...">
                    <div class="media-body">
                ...
                <ul class="media-list list-items">
                  <li class="media">
                    ...
                    <img class="media-object" src="<%=basePath%>/assets/admin/layout/img/avatar6.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    ...
                    <img class="media-object" src="<%=basePath%>/assets/admin/layout/img/avatar7.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    <img class="media-object" src="<%=basePath%>/assets/admin/layout/img/avatar8.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    ...
                    <img class="media-object" src="<%=basePath%>/assets/admin/layout/img/avatar9.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    <img class="media-object" src="<%=basePath%>/assets/admin/layout/img/avatar10.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    ...
                    <img class="media-object" src="<%=basePath%>/assets/admin/layout/img/avatar11.jpg" alt="...">
                    <div class="media-body">
              ...
              <div class="page-quick-sidebar-item">
                <div class="page-quick-sidebar-chat-user">
                  ...
                  <div class="page-quick-sidebar-chat-user-messages">
                    <div class="post out">
                      <img class="avatar" alt="" src="<%=basePath%>/assets/admin/layout/img/avatar3.jpg"/>
                      <div class="message">
                        <span class="arrow"></span>
                    ...
                    <div class="post in">
                      <img class="avatar" alt="" src="<%=basePath%>/assets/admin/layout/img/avatar2.jpg"/>
                      <div class="message">
                        <span class="arrow"></span>
...
<script src="<%=basePath%>/assets/global/plugins/amcharts/amcharts/amcharts.js" type="text/javascript" ></script>
<script src="<%=basePath%>/assets/global/plugins/amcharts/amcharts/serial.js" type="text/javascript" ></script>
<script src="<%=basePath%>/assets/global/plugins/amcharts/amcharts/pie.js" type="text/javascript" ></script>
<script src="<%=basePath%>/assets/global/plugins/amcharts/amcharts/themes/light.js" type="text/javascript" ></script>
<script src="<%=basePath%>/assets/global/plugins/morris/morris.min.js" type="text/javascript"></script>
<script src="<%=basePath%>/assets/global/plugins/morris/raphael-min.js" type="text/javascript"></script>
...
<script src="<%=basePath%>/assets/admin/layout6/scripts/layout.js" type="text/javascript"></script>
<script src="<%=basePath%>/assets/admin/layout6/scripts/quick-sidebar.js" type="text/javascript"></script>
<script src="<%=basePath%>/assets/admin/layout6/scripts/index.js" type="text/javascript"></script>
